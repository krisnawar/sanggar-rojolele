                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="judul" id="judul" class="form-control" placeholder="Masukkan judul artikel">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="konten" id="summernote"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="selectcategory" id="sc1" value="choose" onchange="document.getElementById('choosecat').style.display = 'block'; document.getElementById('addcat').style.display = 'none'">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="categorychosen" id="choosecat" style="display: none;">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input style="font-size: 0.875rem;" type="file" accept="image/*" name="foto_headline" id="foto_headline" class="form-control" onchange="document.getElementById('hasil_gambar').src = window.URL.createObjectURL(this.files[0]); document.getElementById('hasil_gambar').style.display = 'block'">
